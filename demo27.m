img=dicomread('E:\CTLearning\s5\i000027.dcm'); 
info =dicominfo('E:\CTLearning\s5\i000027.dcm'); 
...
%             end
            ...
            imgDst(lines_i(cm),lines_j(cm)) = vaDst + (10-cm);   %%%%%%%%
            imgDst2(lines_i(cm),lines_j(cm)) = vaDst+(10-cm);    %%%%%%%%  
...
dicomwrite(imgDst3,'E:\CTLearning\s5\i000027_2.dcm', 'CreateMode','Copy',info);
fclose(fp);
fclose(fp2);
