img=dicomread('E:\CTLearning\s5\i000007.dcm'); 
info =dicominfo('E:\CTLearning\s5\i000007.dcm'); 
...
dicomwrite(imgDst3,'E:\CTLearning\s5\i000007_2.dcm', 'CreateMode','Copy',info);
fclose(fp);
fclose(fp2);
